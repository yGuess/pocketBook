...
package bill {
   ...
   * @return IfFailed:  {code=ERRCODE, message=ERRMESSAGE}
   */
  AddBills(billId Number, amount Number, type String, countName String, remarks String) JSON
   ...
   * @return IfFailed:  {code=ERRCODE, message=ERRMESSAGE}
   */
  ModifyBills(billId Number, amount Number, type String, countName String, remarks String) JSON
